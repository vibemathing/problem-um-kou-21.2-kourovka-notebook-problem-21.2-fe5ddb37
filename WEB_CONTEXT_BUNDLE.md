...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.2"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-v1",
      "problem_contract_sha256": "6d23a01c3d048e5edd71d179dc426f3cc83810fdbc33ad6e8a223bd17d26a1cd",
      "problem_id": "problem:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37",
      "route_id": "route:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-source-fidelity-01",
      "graph_id": "graph:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $S$ be a finite simple group, and let $G$ be a finite group for which there exists a bijection $f:G\\to S$ such that $|x|$ divides $|f(x)|$ for all $x\\in G$. Must $G$ necessarily be simple?"
          },
          "statement_sha256": "f2d8ff3498152f609e9c4362d6ec1d0ed9b13d64fd82320dec5d103b704c116f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-root",
      "route_id": "route:um-kou-21.2-kourovka-notebook-problem-21.2-fe5ddb37-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.2-29a2817995c6",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.2"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
